...
export default function BrouzdalPage() {
  ...
  return (
    <div className="h-screen flex flex-col bg-gradient-to-br from-blue-50 via-cyan-50 to-blue-100">
        ...
        <div className="max-w-full px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex gap-8 absolute left-1/2 transform -translate-x-1/2">
              ...
              <Link href="/brouzdal" className="text-blue-600 font-semibold flex items-center gap-2">
      ...
      <div className="flex flex-1 overflow-hidden pt-16">{/* pt-16 for navbar height */}
        {/* Chat Section - 1/2 */}
